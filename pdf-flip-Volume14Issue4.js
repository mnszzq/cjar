                                                        ...
                                                        $(document).on('click','#Title3',function(){
                                                            $("#magazine").turn('page', 26);
                                                                ...
                                                                $(document).on('click','#Title4',function(){
                                                                    $("#magazine").turn('page', 50);
                                                                });
                                                                        $(document).on('click','#Title5',function(){
                                                                            $("#magazine").turn('page', 75);
                                                                        });
                                                                                $(document).on('click','#Title6',function(){
                                                                                    $("#magazine").turn('page', 96);
                                                                                });
                                                                                  $(document).on('click','#Title7',function(){
                                                                                                                            $("#magazine").turn('page', 118);
                                                                                                                        });
                                                                                                                                $(document).on('click','#Title8',function(){
                                                                                                                                    $("#magazine").turn('page', 137);
                                                                                                                                });
                                                                                                                                        $(document).on('click','#Title9',function(){
                                                                                                                                            $("#magazine").turn('page', 139);
                                                                                                                                        });
                                                                                                                                                $(document).on('click','#Title10',function(){
                                                                                                                                                    $("#magazine").turn('page', 141);
                                                                                                                                                });
